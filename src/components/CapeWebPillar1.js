...
export function Pillar1Completion() {
    ...
    const downloadSummary = () => {
        const content = [
            ...
            '',
            'MENTORSHIP & COMMUNITIES (SOUTH AFRICA):',
            '----------------------------------------',
            '- SEDA: Government support and funding (seda.org.za)',
            '- Awethu Project: Incubation for real-world businesses.',
            '- Silicon Cape: The tech ecosystem hub in Cape Town.',
            '- Startup Grind: Local chapters for networking.',
            '',
            'YOUR NEXT STEP:',
            '---------------',
