...
import {
  Pillar1JourneyMap, Pillar1ModuleA, Pillar1ModuleB, Pillar1ModuleC, Pillar1ModuleD, Pillar1ModuleE,
...
import {
  ...
  Pillar3Quiz, Pillar3Completion, pillar3QuizQuestions
} from './CapeWebPillar3';
import {
...
import {
  Pillar5ModuleA, Pillar5ModuleB, Pillar5ModuleC, Pillar5ModuleD, Pillar5ModuleE,
  Pillar5ModuleF, Pillar5ModuleG, Pillar5ModuleH, Pillar5ModuleI,
  Pillar5Quiz, Pillar5Completion, pillar5QuizQuestions
} from './CapeWebPillar5';
import {
  Pillar6ModuleA, Pillar6ModuleB, Pillar6ModuleC, Pillar6ModuleD, Pillar6ModuleE,
  Pillar6ModuleF, Pillar6ModuleG, Pillar6ModuleH, Pillar6ModuleI,
...
import {
  ...
  Pillar10ModuleF, Pillar10ModuleG,
...
import {
  ...
  Pillar11ModuleF, Pillar11ModuleG,
...
export default function CapeWebBlueprint() {
  ...
  const [activeModule, setActiveModule] = useState('p1-module-a');
              ...
              {isPillar4Expanded && (
                <div className="pillar-modules" id="pillar-content-pillar-mobile">
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-a' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-a')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module A · Mobile Strategy</div><p>App vs Web, and planning your MVP.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-b' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-b')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module B · No-Code Mobile</div><p>FlutterFlow, Adalo, and visual builders.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-c' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-c')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module C · React Native</div><p>Building cross-platform apps with JS.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-d' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-d')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module D · Flutter Dev</div><p>Building beautiful apps with Google's toolkit.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-e' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-e')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module E · Native iOS/Android</div><p>When to go native (Swift/Kotlin).</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-f' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-f')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module F · Backend & APIs</div><p>Connecting your app to the cloud.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-g' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-g')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module G · App Store Publish</div><p>Google Play & Apple App Store guides.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-h' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-h')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module H · Mobile UX/UI</div><p>Designing for thumbs and small screens.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-i' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-i')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module I · Optimization</div><p>Performance, battery, and app size.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-j' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-j')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module J · Testing & QA</div><p>Beta testing and avoiding crashes.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p4-module-k' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p4-module-k')}>
                    <div className="module-pill">Pillar 4</div><div><div className="module-title">Module K · Monetization</div><p>IAP, subscriptions, and analytics.</p></div>
                  </button>
                </div>
              )}
            </div>
              ...
              {isPillar5Expanded && (
                <div className="pillar-modules" id="pillar-content-pillar-seo">
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-a' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-a')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module A · SEO Fundamentals</div><p>Technical, Content, and Authority pillars.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-b' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-b')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module B · Keyword Research</div><p>Finding what South Africans search for.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-c' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-c')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module C · On-Page SEO</div><p>Titles, metas, and structure.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-d' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-d')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module D · Technical SEO</div><p>Sitemaps, robots.txt, and speed.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-e' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-e')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module E · Local SEO</div><p>Google Business Profile & Maps domination.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-f' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-f')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module F · Content Strategy</div><p>Topic clusters and pillar pages.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-g' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-g')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module G · Link Building</div><p>Getting votes of confidence (backlinks).</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-h' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-h')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module H · Tools & Metrics</div><p>Google Search Console & Analytics.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p5-module-i' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p5-module-i')}>
                    <div className="module-pill">Pillar 5</div><div><div className="module-title">Module I · E-commerce SEO</div><p>Ranking products and categories.</p></div>
                  </button>
                </div>
              )}
            </div>
              ...
              {isPillar6Expanded && (
                <div className="pillar-modules" id="pillar-content-pillar-marketing">
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-a' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-a')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module A · Traffic Temperature</div><p>Cold, Warm, and Hot traffic strategies.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-b' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-b')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module B · Intent Marketing</div><p>Google Ads & winning the search auction.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-c' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-c')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module C · Interruption Marketing</div><p>Social media ads & stopping the scroll.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-d' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-d')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module D · StoryBrand Framework</div><p>Making the customer the hero, not the guide.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-e' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-e')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module E · The Grand Slam Offer</div><p>Making it stupid for them to say no.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-f' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-f')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module F · Owned Media</div><p>Building an asset you actually own (Email).</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-g' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-g')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module G · Retargeting</div><p>Following lost visitors back to the sale.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-h' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-h')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module H · Analytics & ROAS</div><p>Marketing by the numbers: ROAS, CAC, LTV.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p6-module-i' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p6-module-i')}>
                    <div className="module-pill">Pillar 6</div><div><div className="module-title">Module I · Content Strategy</div><p>Jab, Jab, Jab, Right Hook (Giving Value).</p></div>
                  </button>
                </div>
              )}
            </div>
              ...
              {isPillar7Expanded && (
                <div className="pillar-modules" id="pillar-content-pillar-ai">
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-a' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-a')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module A · The Centaur Model</div><p>Strategy: Human + AI leverage.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-b' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-b')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module B · How LLMs Work</div><p>Tokens, probability, and hallucinations.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-c' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-c')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module C · Prompt Engineering</div><p>The art of giving context & role.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-d' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-d')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module D · Generative Art</div><p>Midjourney & DALL-E for brand assets.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-e' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-e')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module E · Automation Pipelines</div><p>Zapier: Connecting your tech stack.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-f' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-f')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module F · AI Support</div><p>Chatbots & 24/7 client deflection.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-g' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-g')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module G · Data Analysis</div><p>Python-powered business intelligence.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-h' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-h')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module H · Autonomous Agents</div><p>AI that plans & executes multi-step goals.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p7-module-i' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p7-module-i')}>
                    <div className="module-pill">Pillar 7</div><div><div className="module-title">Module I · Meeting Intelligence</div><p>Never take manual notes again.</p></div>
                  </button>
                </div>
              )}
            </div>
              ...
              {isPillar11Expanded && (
                <div className="pillar-modules" id="pillar-content-pillar-cx">
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-a' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-a')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module A · CX Strategy</div><p>Why customer service is your best marketing channel.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-b' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-b')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module B · Support Foundations</div><p>Speed, accuracy, and the human touch.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-c' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-c')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module C · Help Desk</div><p>Moving from Gmail to professional ticketing tools.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-d' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-d')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module D · Knowledge Base</div><p>Letting customers solve their own problems 24/7.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-e' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-e')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module E · Chat & WhatsApp</div><p>Closing sales with instant answers.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-f' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-f')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module F · Feedback</div><p>Measuring customer loyalty with Net Promoter Score.</p></div>
                  </button>
                  <button type="button" className={`pillar-module ${activeModule === 'p11-module-g' ? 'is-active' : ''}`} onClick={() => handleModuleChange('p11-module-g')}>
                    <div className="module-pill">Pillar 11</div><div><div className="module-title">Module G · Retention</div><p>Fixing mistakes and keeping customers for life.</p></div>
                  </button>
                </div>
              )}
            </div>
        ...
        <div className="learn-capeweb-article" ref={articleRef}>
          {activePillar === 1 ? (
            <>
              ...
              {activeModule === 'p1-module-e' && <Pillar1ModuleE onNext={() => setActiveModule('p1-quiz')} />}
            ...
            <>
              ...
              {activeModule === 'p2-module-bonus' && <Pillar2ModuleBonus onNext={() => handleModuleChange('p2-quiz')} />}
            ...
            <>
              ...
              {activeModule === 'p3-module-j' && <Pillar3ModuleJ />}
            ...
            <>
              ...
              {activeModule === 'p6-module-i' && <Pillar6ModuleI />}
            ...
            <>
              ...
              {activeModule === 'p7-module-i' && <Pillar7ModuleI />}
            ...
            <>
              ...
              {activeModule === 'p8-module-i' && <Pillar8ModuleI />}
            ...
            <>
              ...
              {activeModule === 'p9-module-f' && <Pillar9ModuleF />}
            ...
            <>
              ...
              {activeModule === 'p10-module-g' && <Pillar10ModuleG />}
            ...
            <>
              ...
              {activeModule === 'p11-module-g' && <Pillar11ModuleG />}
